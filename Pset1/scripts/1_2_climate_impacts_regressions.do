...
reghdfe log_emp_farm `temp_bins', absorb(fips year) vce(robust)
preserve
...
reghdfe log_farm_prop_income_pc spline*, absorb(fips year) vce(robust)
preserve
regsave, tstat pval ci
gen depvar =  "`=e(depvar)'"
gen controls = "No"
...
* 3
local temp_bins "tempB0 temp0to4 temp4to8 temp8to12 temp12to16 temp16to20 o.temp20to24 temp24to28 temp28to32 tempA32"
local temp_bins_interacted "`temp_bins' c.tempB0#c.tempA32 c.temp0to4#c.tempA32 c.temp4to8#c.tempA32 c.temp8to12#c.tempA32 c.temp12to16#c.tempA32 c.temp16to20#c.tempA32 c.temp24to28#c.tempA32 c.temp28to32#c.tempA32 c.tempA32#c.tempA32 "
reghdfe log_emp_farm `temp_bins_interacted', absorb(fips year) vce(robust)
preserve
regsave, tstat pval ci
gen depvar =  "`=e(depvar)'"
gen controls = "No"
...
restore
test c.tempB0#c.tempA32 c.temp0to4#c.tempA32 c.temp4to8#c.tempA32 ///
	c.temp8to12#c.tempA32 c.temp12to16#c.tempA32 c.temp16to20#c.tempA32 ///
	c.temp24to28#c.tempA32 c.temp28to32#c.tempA32 c.tempA32#c.tempA32
